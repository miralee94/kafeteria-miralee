...
public class JDBCUtilstest {
    ...
    JDBCUtils JDBCUtilsObject = new JDBCUtils("localhost", "3306");
    @Test
    public void listDrinks() {
        ...
        assertEquals(listDrinkDetails.size(), 24);
        ...
        assertEquals(listDrinkDetails.get(0).getDrinkName(),"Coffee");
        ...
        assertEquals(listDrinkDetails.get(1).getDrinkPrice(),45);
    }
